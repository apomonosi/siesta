...
! Tangled code
  ...
  subroutine pexsi_local_dos( )
    ...
    if (SIESTA_worker) then
       ...
       aux: block
         real(dp) :: Enaatm, Enascf, Uatm, Uscf, DUscf  ! local dummies
         real(dp) :: DUext, Exc, Dxc                    ! local dummies
  ...
  use mpi_siesta
  use iso_c_binding
  use siesta_pexsi_interface, only: f_ppexsi_options
  use siesta_pexsi_interface, only: f_ppexsi_plan_finalize
  use siesta_pexsi_interface, only: f_ppexsi_plan_initialize
  use siesta_pexsi_interface, only: f_ppexsi_selinv_complex_symmetric_matrix
  use siesta_pexsi_interface, only: f_ppexsi_load_real_hs_matrix
  use siesta_pexsi_interface, only: f_ppexsi_set_default_options
