...
\input{tex/sections/TranSIESTA/Source_code.tex}

\subsection{TranSIESTA Compilation}

\input{tex/sections/TranSIESTA/Compilation.tex}

\subsection{TranSIESTA: Brief description}
\label{sec:transiesta:description}

\input{tex/sections/TranSIESTA/Description.tex}

\subsection{Electrodes}

\input{tex/sections/TranSIESTA/Electrodes.tex}

\subsection{Convergence of electrodes and scattering regions}

\input{tex/sections/TranSIESTA/Convergence.tex}

\subsection{NEGF equations}
\label{sec:negf-equations}

\input{tex/sections/TranSIESTA/Negf_equations.tex}

\subsection{\texorpdfstring{\tsiesta\ }{TranSIESTA} Options}

\input{tex/sections/TranSIESTA/Options.tex}

\subsection{TranSIESTA \texorpdfstring{$k$}{k}-point sampling}

\input{tex/sections/TranSIESTA/Kpoint_sampling.tex}

\subsection{Output}

\input{tex/sections/TranSIESTA/Output.tex}
