...
\begin{fdfentry}{PAO!SplitNorm}[real]<$0.15$>
  ...
  \note When using \fdf{PAO!SplitTailNorm} \fdftrue (the default as of
...
\begin{fdflogicalF}{PAO!FixSplitTable}
  ...
  radius of the first-zeta orbital.\fdf{PAO!FixSplitTable} \fdftrue
...
% \fdf{PSML!Vlocal} and \fdf{PSML!KB.projectors} were referenced here, but
% they are not defined elsewhere and are clearly debugging options that should
% not be present in the manual.
