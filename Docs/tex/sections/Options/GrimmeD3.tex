...
$ E_{2body} = \sum_{A,B} \frac{ s_{6} C_{6}^{AB}}{ (r_{AB})^6 } f_{6}(r_{AB}) + \sum_{A,B} \frac{ s_{8} C_{8}^{AB}}{ (r_{AB})^8 } f_{8}(r_{AB})$

$ f_{n}(r_{AB}) = \frac{ 1}{1 + 6 \left (\frac{r_{AB}}{Sr_{n} R_{0}^{AB}} \right )^{-\alpha_{n}} } $
...
$ E_{ABC} = \frac{ 1 + 3 cos(\theta_{ABC}) cos(\theta_{BCA}) cos(\theta_{ACB}) }{ ( r_{AB} r_{BC} r_{AC} ) ^{3} } C_{9}^{ABC} $
...
\href{https://www.chemie.uni-bonn.de/pctc/mulliken-center/software/dft-d3/dft-d3}{https://www.chemie.uni-bonn.de/pctc/mulliken-center/software/dft-d3/dft-d3}
